    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('OWL', 'Owls'), ('BOK', 'Books'), ('CRE', 'Magical Creatures'), ('WAN', 'Wands'), ('QUI', 'Quidditch Supplies'), ('WWW', 'Everything a Mischief-Maker Could Possibly Want')], default='WWW', max_length=3)),
